...
DL_BUTTONS=[
    [
        ...
        InlineKeyboardButton('• مع علامه مائيه .', callback_data='wm'),
    ],
...
async def _start(bot, update):
  await update.reply_text(f"- اهلا بك عزيزي .\n- انا بوت تحميل من تيك توك .\n- استطيع تحميل الساوند والفيديو .\n- فقط ارسل رابط الفيديو المراد تحميله .\n- تحميل الفيد بدون علامه مائيه ومع علامه مائيه .\n\n• مطوري : @VR_LA",
...
async def _tiktok(bot, update):
  ...
  if not 'tiktok.com' in resp.url:
    return
  await update.reply('• اختار .', True, reply_markup=InlineKeyboardMarkup(DL_BUTTONS))
